...
export default function ArticleContent({ post }: ArticleContentProps) {
  const [groupeLocalPost, setGroupeLocalPost] =
    useState<GroupeLocalPost | null>(null);
  ...
  const groupeLocalId =
    post.acf?.tax_groupe_local || post.acf?.groupe_local_tax || null;
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="relative h-full min-h-[300px] rounded-lg overflow-hidden">
              <Image
                src={
                  featuredImage ||
                  `/placeholder.svg?height=600&width=600&query=Event ${
                    encodeURIComponent(post.title.rendered) ||
                    "/placeholder.svg"
                  }`
                }
                alt=""
            ...
            <div className="bg-white border shadow-sm rounded-lg p-6 flex flex-col space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="uppercase text-muted-foreground">
                    Date et heure
                  </h3>
                </div>
                  ...
                  <>
                    ...
                    {post.acf?.heure_de_levenement && (
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          <TimeFormat timeStr={post.acf.heure_de_levenement} />
                        </span>
                      </div>
                    )}
                  </>
          ...
          <div className="lg:w-2/3 w-full md:px-4 lg:py-8 p-4">
            ...
            {acfFields.length > 0 &&
              ...
              acfFields.some(([key]) =>
                [
                  "auteur",
                  "lien_de_la_publication",
                  "date_de_la_publication",
                  "auteur_et_media",
                  "lien_vers_larticle",
                ].includes(key)
              ) && (
                        ...
                        <div className="space-y-1">
                          ...
                          {post.acf?.date_de_la_publication && (
                            <>
                              ...
                              <dd className="text-sm">
                                <div className="text-primary hover:underline">
                                  <DateFormat
                                    dateStr={post.acf.date_de_la_publication}
                                  />
                                </div>
                              </dd>
                            </>
                          ...
                          {post.acf?.auteur_et_media && (
                            <>
                              ...
                              <dd className="text-sm">
                                <div>{post.acf.auteur_et_media}</div>
                              </dd>
                            </>
                          )}
