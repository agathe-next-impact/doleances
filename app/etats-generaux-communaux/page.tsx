...
import { fetchPageBySlug, fetchRandomVerbatim } from "@/lib/api";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    ...
    description:
      page?.content?.rendered || "Les Etats Généraux communaux des doléances",
          ...
          <div className="h-max flex flex-col lg:col-span-2 col-span-6 gap-4 overflow-hidden">
            <div className="items-end border rounded-lg bg-card shadow-lg overflow-hidden mb-8">
              <YoutubeEmbed
                videoLink={
                  page?.acf?.video ||
                  "https://www.youtube.com/embed/8bof5Anluk4?si=H5M7BGGsvWFUODBM"
                }
              />
            </div>
